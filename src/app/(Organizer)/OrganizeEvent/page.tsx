...
export default function OrganizePage() {
  ...
  return !isToken ? (
    ...
    <main className="bg-neutral-100 dark:bg-gray-900 w-full min-h-screen h-[auto] flex flex-col items-center mt-[70px] py-16">
      <div className="w-[100%] h-[100%] flex flex-col items-center text-center space-y-8">
        <div className="w-[80%] h-[20vh] flex flex-col items-center">
          <div className="text-4xl text-black dark:text-gray-200 font-semibold w-[100%] h-[60%] flex items-center ">
            Organizer Zone
          </div>
          <div className="text-gray-500 dark:text-gray-400 text-sm font-semibold w-[100%] h-[40%] flex items-start justify-start text-start">
