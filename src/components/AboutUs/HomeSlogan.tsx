...
export default function HomeSlogan() {
  return (
    <div className="w-[80%] h-[20vh] space-x-12 items-center mt-24 mb-10 flex flex-col text-black dark:text-gray-200 font-bold text-4xl">
      Why use BookWing ?
      <div className="w-[100%] h-[100%] flex flex-row justify-between mt-10">
        <div className="w-[25%] text-black text-base font-normal flex flex-col justify-center items-center ">
          ...
          />
          <div className="w-[100%] h-[20%] text-black dark:text-gray-200 text-center font-semibold flex flex-col justify-center">
            Safety First
          </div>
          <div className="w-[100%] h-[20%] text-gray-600 dark:text-gray-400 text-center ">
            Your safety is our priority. verify all organizer and event.
          </div>
        </div>
        <div className="w-[25%] text-black dark:text-gray-200 text-base font-normal flex flex-col justify-center items-center">
