...
export default function EventBookingDatail({
  event,
  type,
}: {
  event: Event;
    ...
    <div className="flex bg-white w-[65%] h-[50vh] justify-between px-8 py-5 rounded-xl shadow-lg border-2 border-black hover:cursor-pointer mb-20">
      <div className="flex flex-col min-w-[55%] justify-between">
        ...
        <div className="flex mb-4">
          ...
          <div className="text-black">: {decodeURIComponent(type)}</div>
        </div>
        <div className="flex mb-4">
          <LocationOnIcon className="text-black mr-1" />
          <div className="text-black font-semibold mr-1 w-[20%]">Location</div>
        ...
        <div className="flex mb-4">
          ...
          <div className="text-black font-semibold mr-1 w-[20%]">Organizer</div>
